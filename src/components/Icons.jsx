...
// Ícone de Mão com Coração (Doador)
export const DonorIcon = ({ size = 20, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Ícone de Gráfico (Dashboard) - BarChart
export const BarChartIcon = ({ size = 20, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M7 12H3.5a1.5 1.5 0 0 1-1.5-1.5V5.5a1.5 1.5 0 0 1 1.5-1.5H7"></path>
  </svg>
);

// Ícone de Presente (Doação) - Gift
export const GiftIcon = ({ size = 20, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="20 12 20 22 4 22 4 12"></polyline>
    <rect x="2" y="7" width="20" height="5"></rect>
    <line x1="12" y1="22" x2="12" y2="7"></line>
    <path d="M8 7c0-1.657 1.343-3 3-3h2c1.657 0 3 1.343 3 3"></path>
  </svg>
);

// Ícone de Caminhão (Distribuição) - Truck
export const TruckIcon = ({ size = 20, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="1" y="3" width="15" height="13"></rect>
    <polygon points="16 8 20 8 23 11 23 16"></polygon>
    <circle cx="5.5" cy="18.5" r="2.5"></circle>
    <circle cx="18.5" cy="18.5" r="2.5"></circle>
  </svg>
);

// Ícone de Caixa (Estoque) - Box
...
// Ícone de Edifício (Instituição) - Building
export const BuildingIcon = ({ size = 20, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="3" width="18" height="18"></rect>
    <path d="M9 9h1v8"></path>
    <path d="M14 9h1v8"></path>
    <line x1="3" y1="21" x2="21" y2="21"></line>
  </svg>
);

// Ícone de Usuários (Plural) - Users
